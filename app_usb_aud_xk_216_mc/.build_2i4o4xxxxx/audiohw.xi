...
# 1 "/Applications/XMOS_XTC_15.3.1/target/include/assert.h" 1 3
...
# 10 "/Applications/XMOS_XTC_15.3.1/target/include/assert.h" 2 3
# 44 "/Applications/XMOS_XTC_15.3.1/target/include/assert.h" 3
...
# 1 "/Users/cwu/Desktop/GIT/Audio_Sound/app_usb_aud_xk_216_mc/.build_2i4o4xxxxx/audiocard_mc.h" 1 3
# 13 "/Users/cwu/Desktop/GIT/Audio_Sound/app_usb_aud_xk_216_mc/.build_2i4o4xxxxx/audiocard_mc.h" 3
...
# 1 "/Users/cwu/Desktop/Audio_Sound/module_i2c_shared/src/i2c_shared.h" 1
# 10 "/Users/cwu/Desktop/Audio_Sound/module_i2c_shared/src/i2c_shared.h"
...
# 11 "/Users/cwu/Desktop/Audio_Sound/module_i2c_shared/src/i2c_shared.h" 2
# 1 "/Users/cwu/Desktop/Audio_Sound/module_i2c_simple/src/i2c.h" 1
# 13 "/Users/cwu/Desktop/Audio_Sound/module_i2c_simple/src/i2c.h"
# 1 "../src/extensions/i2c_conf.h" 1
# 14 "/Users/cwu/Desktop/Audio_Sound/module_i2c_simple/src/i2c.h" 2
# 69 "/Users/cwu/Desktop/Audio_Sound/module_i2c_simple/src/i2c.h"
struct r_i2c {
    port scl;
    port sda;
};
...
# 94 "/Users/cwu/Desktop/Audio_Sound/module_i2c_simple/src/i2c.h"
int i2c_master_rx(int device, unsigned char data[], int nbytes,
                  struct r_i2c &i2c);
# 110 "/Users/cwu/Desktop/Audio_Sound/module_i2c_simple/src/i2c.h"
int i2c_master_read_reg(int device, int reg_addr,
                        unsigned char data[],
                        int nbytes,
                        struct r_i2c &i2c_master);
# 132 "/Users/cwu/Desktop/Audio_Sound/module_i2c_simple/src/i2c.h"
int i2c_master_write_reg(int device, int reg_addr,
                         const unsigned char data[],
                         int nbytes,
                         struct r_i2c &i2c_master);
# 12 "/Users/cwu/Desktop/Audio_Sound/module_i2c_shared/src/i2c_shared.h" 2




void i2c_shared_master_init(struct r_i2c &i2cPorts);
# 28 "/Users/cwu/Desktop/Audio_Sound/module_i2c_shared/src/i2c_shared.h"
int i2c_shared_master_rx(struct r_i2c &i2cPorts, int device, unsigned char data[],
    int nbytes);
# 41 "/Users/cwu/Desktop/Audio_Sound/module_i2c_shared/src/i2c_shared.h"
int i2c_shared_master_read_reg(struct r_i2c &i2cPorts, int device, int reg_addr,
    unsigned char data[], int nbytes);
# 58 "/Users/cwu/Desktop/Audio_Sound/module_i2c_shared/src/i2c_shared.h"
...
# 1 "../src/extensions/si5351a.h" 1
# 16 "../src/extensions/si5351a.h"
typedef struct
{
...
si5351a_register_t const si5351a_registers_22m[(44)] =
{
    { 0x0002, 0x53 },
    { 0x0003, 0x00 },
    { 0x0004, 0x20 },
...
si5351a_register_t const si5351a_registers_24m[(62)] =
{
    { 0x0002, 0x53 },
    { 0x0003, 0x06 },
    { 0x0004, 0x20 },
...
si5351a_register_t const si5351a_registers_49m[(62)] =
{
    { 0x0002, 0x53 },
    { 0x0003, 0x06 },
    { 0x0004, 0x20 },
...
on tile [0] : struct r_i2c i2cPorts = {on tile[0]: 0x10300, on tile[0]: 0x10200};
...
static void si5351a_init(unsigned mClk)
{
    ...
    if (mClk == (512*44100))
    {
        for(i = 0; i < (44); i++)
        {
            {data[0] = si5351a_registers_22m[i].value; i2c_master_write_reg((0x60), si5351a_registers_22m[i].address, data, 1, i2cPorts);};
        }
    }
    else
    {
        for(i = 0; i < (62); i++)
        {
            {data[0] = si5351a_registers_24m[i].value; i2c_master_write_reg((0x60), si5351a_registers_24m[i].address, data, 1, i2cPorts);};
        }
    }

    {data[0] = 0xAC; i2c_master_write_reg((0x60), 0xb1, data, 1, i2cPorts);};
    {data[0] = 0x00; i2c_master_write_reg((0x60), 0x03, data, 1, i2cPorts);};
}
...
void AudioHwInit(chanend ?c_codec )
{
    ...
    timer t;
    unsigned int time ;
    const unsigned int period = 100000 * 1500;
    ...
    si5351a_init((512*48000));

}
# 152 "../src/extensions/audiohw.xc"
