# 1 "../src/extensions/cat9555.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/extensions/cat9555.xc" 2
...
# 10 "../src/extensions/cat9555.xc" 2
...
# 11 "../src/extensions/cat9555.xc" 2
...
# 12 "../src/extensions/cat9555.xc" 2
...
# 13 "../src/extensions/cat9555.xc" 2
...
# 18 "../src/extensions/cat9555.xc" 2

unsigned char exio_value = 0x00;
# 28 "../src/extensions/cat9555.xc"
unsigned char cat9555_init(void)
{
    unsigned char data[1]={0};

    if (0 == i2c_master_read_reg(0x20, 0x00, data, 1, i2cPorts )) {
      return 0x00;
    }
