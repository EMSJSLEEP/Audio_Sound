# 1 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 2 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 3 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 4 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
# 1 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/interrupt.h" 1
# 5 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 6 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 13 "/Users/cwu/Desktop/Audio_Sound/app_usb_aud_xk_216_mc/.build_2i4o4xxxxx/audiocard_mc.h" 3
...
# 7 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
...
# 1 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/user_hid.h" 1
# 11 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/user_hid.h"
void UserReadHIDButtons(unsigned char hidData[]);
# 14 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc" 2
# 32 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc"
unsigned int multOut[4 + 1];
static xc_ptr p_multOut;


unsigned int multIn[4 + 1];
static xc_ptr p_multIn;



unsigned g_numUsbChan_Out = 4;
unsigned g_numUsbChan_In = 4;
# 54 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc"
unsigned outAudioBuff[((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10))) + (1028>>2) + 4];
unsigned audioBuffIn[((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10))) + ((((((48000/1000+1)*(10)*4))>((((192000)/8000+1)*4*4)) ? (((48000/1000+1)*(10)*4)) : ((((192000)/8000+1)*4*4))))>>2) + 4];

unsigned inZeroBuff[((((((48000/1000+1)*(10)*4))>((((192000)/8000+1)*4*4)) ? (((48000/1000+1)*(10)*4)) : ((((192000)/8000+1)*4*4))))>>2)+4];
...
int g_maxPacketSize = (((192000)/8000+1)*4*4);
...
#pragma xta endpoint "out_underflow"
 ...
 for(int i = 0; i < 4; i++)
        ...
        if (outSamps < 0)
        {
            outSamps += ((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10)))*4;
        }


        if(outSamps >= (((((10)*((((48000 +999)/1000))+3)*3+4)>(4*(((((192000)+7999)/8000))+3)*4+4) ? ((10)*((((48000 +999)/1000))+3)*3+4) : (4*(((((192000)+7999)/8000))+3)*4+4))*1)))
        {
            outUnderflow = 0;
            outSamps++;
        }
...
#pragma xta endpoint "mixer_request"
 int sample;
        ...
        for(int i = 0; i < 4 - g_numUsbChan_Out; i++)
        {
...
__builtin_unreachable();
            ...
            case 4:
            {
                ...
                for(int i = 0; i < g_numUsbChan_In; i++)
                {
                    ...
                    {h, l} = __builtin_macs(mult, sample, 0, 0);
                    sample = h << 3;
# 354 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc"
        ...
        for(int i = 0; i < 4 - g_numUsbChan_In; i++)
        {
...

    {
        ...
        if (sampsToWrite <= 0)
        {
            ...
            speedRem &= 0xffff;
# 470 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc"
            ...
            if((space_left < (totalSampsToWrite * g_numUsbChan_In * g_curSubSlot_In + 4)))
            {
                ...
                } while(space_left < (((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10)))*4/2));
            }
...
)
{
    ...
    aud_from_host_fifo_end = aud_from_host_fifo_start + ((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10)))*4;
    ...
    aud_to_host_fifo_end = aud_to_host_fifo_start + ((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10)))*4;
    g_aud_to_host_wrptr = aud_to_host_fifo_start;
    ...
    {
        int tmp;
# 684 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc"
        {
            ...
            else if(tmp == 9)
            {
                ...
                {
                    g_maxPacketSize = ((((192000)/8000+1)*4) * g_numUsbChan_In);
                }
                else
                {
...
# 810 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/usb_buffer/decouple.xc"
                __builtin_in_uint(c_mix_out);
        ...
        else if (outOverflow)
        {
            ...
            space_left = aud_from_host_rdptr - aud_from_host_wrptr;
            if (space_left <= 0)
                space_left += ((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10)))*4;
            if (space_left >= (((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10)))*4/2))
            {
...

        {
            ...
            if (tmp)
            {
                ...
                if (inUnderflow)
                {
                    ...
                    if (fill_level < 0)
                        fill_level += ((4 * (((((192000)+7999)/8000))+3) * 4)>(4 * ((((48000 +999)/1000))+3) * (10)) ? (4 * (((((192000)+7999)/8000))+3) * 4) : (4 * ((((48000 +999)/1000))+3) * (10)))*4;

                    if (fill_level >= (((((((48000 +999)/1000))+3)*2+4)>((((((192000)+7999)/8000))+3)*4+4) ? (((((48000 +999)/1000))+3)*2+4) : ((((((192000)+7999)/8000))+3)*4+4))*2))
                    {
                        inUnderflow = 0;
