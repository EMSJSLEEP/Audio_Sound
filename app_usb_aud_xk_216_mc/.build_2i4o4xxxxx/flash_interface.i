# 1 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 290 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c" 2
...
# 2 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c" 2
# 1 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 1 3
# 34 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
typedef enum {
  PROT_TYPE_UNKNOWN=-1,
  PROT_TYPE_NONE=0,
  PROT_TYPE_SR=1,
...
# 171 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_connect(fl_SPIPorts* SPI);
# 186 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
int fl_connectToDeviceEx(fl_SPIPorts *SPI, const fl_DeviceSpec spec[], unsigned n);
# 201 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_copySpec(fl_DeviceSpec *dest);
# 210 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
# 224 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_dividerOverride(int div);
# 234 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_getFlashType();
...
# 256 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
unsigned fl_getSpiId(fl_SPIPorts * SPI, unsigned id_command);
# 266 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
void fl_spiInit(fl_SPIPorts * pHolder, int div);
...
# 304 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
# 350 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_getFactoryImage(fl_BootImageInfo* bootImageInfo);
# 364 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_getNextBootImage(fl_BootImageInfo* bootImageInfo);
# 375 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
unsigned fl_getImageTag(fl_BootImageInfo* bootImageInfo);
# 386 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
unsigned fl_getImageVersion(fl_BootImageInfo* bootImageInfo);
# 397 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
unsigned fl_getImageAddress(fl_BootImageInfo* bootImageInfo);
# 408 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
unsigned fl_getImageSize(fl_BootImageInfo* bootImageInfo);
# 419 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_getToolsMajor(fl_BootImageInfo* bootImageInfo);
# 430 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_getToolsMinor(fl_BootImageInfo* bootImageInfo);
# 441 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_getToolsPatch(fl_BootImageInfo* bootImageInfo);
# 452 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_getImageFormat(fl_BootImageInfo* bootImageInfo);
# 471 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_startImageAdd(fl_BootImageInfo *bootImageInfo, unsigned maxsize,
                     unsigned padding);
# 491 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_startImageAddAt( unsigned offset, unsigned maxsize);
# 509 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_startImageReplace(fl_BootImageInfo *bootImageInfo, unsigned maxsize);
# 521 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
# 547 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_startDeleteImage(fl_BootImageInfo *bootImageInfo);
# 557 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_startImageRead(fl_BootImageInfo *bootImageInfo);
# 567 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
# 588 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
unsigned fl_getDataPartitionSize(void);
# 598 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
int fl_readData(unsigned offset, unsigned size, unsigned char dst[]);
# 607 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
unsigned fl_getWriteScratchSize(unsigned offset, unsigned size);
# 619 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
# 643 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 3
...
# 1 "/Applications/XMOS_XTC_15.3.1/target/include/SpecEnum.h" 1 3
...
# 686 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 2 3




# 1 "/Applications/XMOS_XTC_15.3.1/target/include/SpecMacros.h" 1 3
# 691 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h" 2 3
# 3 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c" 2
# 1 "/Applications/XMOS_XTC_15.3.1/target/include/flashlib.h" 1 3
# 26 "/Applications/XMOS_XTC_15.3.1/target/include/flashlib.h" 3
...
# 96 "/Applications/XMOS_XTC_15.3.1/target/include/flashlib.h" 3
unsigned int fl_setBootPartitionSize( unsigned int s );
unsigned int fl_getBootPartitionSize();


unsigned fl_getDataPartitionBase();
# 112 "/Applications/XMOS_XTC_15.3.1/target/include/flashlib.h" 3
...
# 4 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c" 2
# 1 "/Applications/XMOS_XTC_15.3.1/target/include/string.h" 1 3
# 10 "/Applications/XMOS_XTC_15.3.1/target/include/string.h" 3
...
# 11 "/Applications/XMOS_XTC_15.3.1/target/include/string.h" 2 3

# 1 "/Applications/XMOS_XTC_15.3.1/target/include/sys/reent.h" 1 3
# 14 "/Applications/XMOS_XTC_15.3.1/target/include/sys/reent.h" 3
...
# 26 "/Applications/XMOS_XTC_15.3.1/target/include/machine/_default_types.h" 3
...
# 78 "/Applications/XMOS_XTC_15.3.1/target/include/sys/reent.h" 3
struct __sFILE {
  unsigned char *_p;
  int _r;
  int _w;
...
# 13 "/Applications/XMOS_XTC_15.3.1/target/include/string.h" 2 3


# 1 "/Applications/XMOS_XTC_15.3.1/target/include/clang/stddef.h" 1 3
# 66 "/Applications/XMOS_XTC_15.3.1/target/include/clang/stddef.h" 3
typedef unsigned int size_t;
# 16 "/Applications/XMOS_XTC_15.3.1/target/include/string.h" 2 3
...
char *strlwr (char *);
char *strupr (char *);
# 102 "/Applications/XMOS_XTC_15.3.1/target/include/string.h" 3
# 1 "/Applications/XMOS_XTC_15.3.1/target/include/sys/string.h" 1 3
# 103 "/Applications/XMOS_XTC_15.3.1/target/include/string.h" 2 3
# 5 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c" 2
...
int clz(unsigned x);
# 6 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c" 2
