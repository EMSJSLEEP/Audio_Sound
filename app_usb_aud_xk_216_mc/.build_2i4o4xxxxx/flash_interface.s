...
.Ldebug_range:
	.file	1 "/Applications/XMOS_XTC_15.3.1/target/include/flash.h"
	.file	2 "/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c"
	.text
...
.Ltmp26:
	...
	.set	flash_cmd_init.nstackwords,((fl_getFactoryImage.nstackwords $M fl_getNextBootImage.nstackwords $M __memcpy_4.nstackwords $M flash_cmd_enable_ports.nstackwords) + 10)
...
.Ltmp81:
	...
	.set	flash_cmd_write_page.nstackwords,((fl_endWriteImage.nstackwords $M __memcpy_4.nstackwords $M fl_getNextBootImage.nstackwords $M fl_startImageAdd.nstackwords) + 12)
...
.Ltmp110:
	...
	.set	flash_cmd_erase_all.nstackwords,((__memcpy_4.nstackwords $M fl_deleteImage.nstackwords $M fl_getNextBootImage.nstackwords) + 12)
...
.Linfo_string1:
.asciiz"/Users/cwu/Desktop/Audio_Sound/module_dfu/src/flash_interface.c"
.Linfo_string2:
...
.LpubTypes_end0:
	...
	.typestring fl_getFactoryImage, "f{si}(p(s(){m(startAddress){ui},m(size){ui},m(version){ui},m(factory){si},m(tag){ui},m(toolsVersion){s(){m(major){uc},m(minor){uc},m(patch){uc},m(compat){uc},m(valid){si}}}}))"
	.typestring fl_getNextBootImage, "f{si}(p(s(){m(startAddress){ui},m(size){ui},m(version){ui},m(factory){si},m(tag){ui},m(toolsVersion){s(){m(major){uc},m(minor){uc},m(patch){uc},m(compat){uc},m(valid){si}}}}))"
	.typestring flash_cmd_deinit, "f{si}(0)"
	.typestring flash_cmd_read_page, "f{si}(p(uc))"
	.typestring fl_startImageRead, "f{si}(p(s(){m(startAddress){ui},m(size){ui},m(version){ui},m(factory){si},m(tag){ui},m(toolsVersion){s(){m(major){uc},m(minor){uc},m(patch){uc},m(compat){uc},m(valid){si}}}}))"
	...
	.typestring fl_deleteImage, "f{si}(p(s(){m(startAddress){ui},m(size){ui},m(version){ui},m(factory){si},m(tag){ui},m(toolsVersion){s(){m(major){uc},m(minor){uc},m(patch){uc},m(compat){uc},m(valid){si}}}}))"
	.typestring fl_startImageAdd, "f{si}(p(s(){m(startAddress){ui},m(size){ui},m(version){ui},m(factory){si},m(tag){ui},m(toolsVersion){s(){m(major){uc},m(minor){uc},m(patch){uc},m(compat){uc},m(valid){si}}}}),ui,ui)"
