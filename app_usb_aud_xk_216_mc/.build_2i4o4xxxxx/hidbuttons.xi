# 1 "../src/extensions/hidbuttons.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../src/extensions/hidbuttons.xc" 2
...
# 3 "../src/extensions/hidbuttons.xc" 2
...
# 4 "../src/extensions/hidbuttons.xc" 2
...
# 6 "../src/extensions/hidbuttons.xc" 2


in port p_sw = on tile[1] : 0x40100;
# 30 "../src/extensions/hidbuttons.xc"
unsigned multicontrol_count = 0;
unsigned wait_counter =0;
# 44 "../src/extensions/hidbuttons.xc"
typedef enum
{
 STATE_IDLE = 0x00,
 STATE_PLAY = 0x01,
