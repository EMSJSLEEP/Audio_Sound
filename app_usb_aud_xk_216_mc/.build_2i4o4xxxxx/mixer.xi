# 1 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 142 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
# 4 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
# 5 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
# 6 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
# 7 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
# 8 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
# 9 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
# 10 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc" 2
...
static unsigned int multOut_array[4 + 1];
static xc_ptr multOut;


static unsigned int multIn_array[4 + 1];
static xc_ptr multIn;
# 39 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
static int samples_array[4 + 4 + 0 + 1];
xc_ptr samples;
...
int savedsamples2[4 + 4 + 0];

int samples_to_host_map_array[4];
xc_ptr samples_to_host_map;

int samples_to_device_map_array[4];
xc_ptr samples_to_device_map;
# 69 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
int samples_to_host_inputs[4];
...
static int samples_from_host_streams[4];

static int samples_mixer_outputs[0];
xc_ptr samples_mixer_outputs_ptr;
# 113 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
...
# 162 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
...
# 198 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
...
# 243 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
 ...
 for (int i=0; i<4; i++)
        {
            ...
            int index;
# 274 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
            unsafe
            {

                sample = ptr_samples[i];
            }
# 294 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
            __builtin_out_uint(c, sample);
 ...
 for (int i=0;i<4;i++)
    {
        ...
        int old_x;
        sample = __builtin_in_uint(c);
# 340 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
        unsafe
        {
            ptr_samples[4 + i] = sample;
        }

  }
}

static int mixer1_mix2_flag = ((48000) > 96000);
 ...
 request = __builtin_in_uint(c_mixer2);
        ...
        select
        {
            case __builtin_in_uint_byref(c_mix_ctl, cmd):
            {
                ...
                switch (cmd)
                {
# 438 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
                    ...
                    case GET_INPUT_LEVELS:
                        index = __builtin_in_uint(c_mix_ctl);
                        __builtin_chkct(c_mix_ctl, 0x1);
# 462 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
                        ...
                        __builtin_outct(c_mix_ctl, 0x1);
                        break;
# 482 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
                }
                break;
            }
            default:
...
#pragma loop unroll
 ...
 for (int i=0;i<0;i++)
        ...
        {
# 609 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
...
# 752 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
...
# 777 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
    for (int i=0;i<4 + 4 + 0;i++)
    unsafe {
...
# 806 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
    for (int i=0;i<4;i++)
    {
      asm volatile("stw %0, %1[%2]"::"r"(4 + i),"r"(samples_to_host_map),"r"(i));
    }
# 823 "/Users/cwu/Desktop/Audio_Sound/module_usb_audio/mixer/mixer.xc"
    par
    {
