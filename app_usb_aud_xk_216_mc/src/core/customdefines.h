 ...
 * Default: XMOS USB Audio Release version (e.g. 0x0651 for 6.15.2).
 */
#define BCD_DEVICE_J             6
#define BCD_DEVICE_M             15
#define BCD_DEVICE_N             3/*2*/ //just for a test
...
#endif
/**
 * @brief Default device sample frequency (Hz). A safe default should be used. Default: MIN_FREQ
 *
 */
#define DEFAULT_FREQ   (48000)/*(96000)*/

//:
/***** Defines relating to USB descriptors etc *****/
//:usb_defs
#define VENDOR_ID          (0x34AA)/*(0x20B1)*/ /* XMOS VID */
#define PID_AUDIO_2        (0x0001)/*(0x0008)*/ /* SKC_SU1 USB Audio Reference Design PID */
