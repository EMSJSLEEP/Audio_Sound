 ...
 */
    ...
    #define NUM_USB_CHAN_IN 10 /* Define anyway for doxygen */
#endif
 ...
 */
    ...
    #define NUM_USB_CHAN_OUT 10 /* Define anyway for doxygen */
#endif
 ...
 */
    ...
    #define I2S_CHANS_DAC 8          /* Define anyway for doxygen */
#else
 ...
 */
    ...
    #define I2S_CHANS_ADC 8      /* Define anyway for doxygen */
#else
...
#define PRODUCT_STR_A2           "Audio Analyzer"
#endif
...
#define PRODUCT_STR_A1           "USB Audio 1.0"
#endif
...
/* For Audio Class 1.0 and Full-speed Audio 2.0 we default having at most 2 channels */
        ...
        #define NUM_USB_CHAN_OUT_FS  (10) //(2)
    #else
        ...
        #define NUM_USB_CHAN_IN_FS (10) //(2)
    #else
